package cn.fzzhuang.infrastructure.persist.repository;

import cn.fzzhuang.domain.task.model.entity.Task;
import cn.fzzhuang.domain.task.repository.TaskRepository;
import cn.fzzhuang.infrastructure.mq.EventPublisher;
import cn.fzzhuang.infrastructure.persist.converter.TaskConverter;
import cn.fzzhuang.infrastructure.persist.dao.impl.TaskDao;
import cn.fzzhuang.infrastructure.persist.po.TaskPO;
import cn.fzzhuang.types.utils.AssertUtil;
